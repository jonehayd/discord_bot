...
const WORDS = ['electricity', 'donkey', 'hardware', 'xerox', 'transistor', 'computer', 'desktop',
 'engineering', 'hangman', 'circuit', 'imagination', 'robot', 'memory', 'power', 
 'submarine', 'chess', 'resistance', 'matrix', 'function', 'laser', 'mechanism', 
 'bodyguard', 'titanic', 'global', 'ozone', 'bridge', 'technology', 'spider', 'unpleasant',
 'pyramid', 'sphere', 'member', 'warning', 'yourself', 'screen', 'language', 'elephant',
 ...
 'harvest', 'hunger', 'woman', 'children', 'stranger', 'garden', 'pleasure', 'laughing',
 'between', 'recognition', 'tomorrow', 'autumn', 'monkey', 'spring', 'winter', 'mountain',
 'classification', 'typewriter', 'success', 'difference', 'acoustics', 'astronomy',
 'agreement', 'sorrow', 'christmas', 'silver', 'birthday', 'championship', 'friends',
 ...
 'mountain', 'treasure', 'machine', 'whispering', 'eternity', 'reflection', 'occurence',
 ...
 'happen', 'happiness', 'worry', 'method', 'tolerance', 'error', 'hesitation', 'ratio',
 ...
 'surprise', 'nothing', 'ladder', 'opposite', 'reality', 'genius', 'string', 'dissent',
 ...
 'abrupt', 'absolute', 'absorption', 'abstract', 'academy', 'acceleration', 'accelerate',
 ...
 'agenda', 'airport', 'algorithm', 'allocation', 'aluminium', 'ambiguity', 'amphibian', 
 'anaesthesia', 'analogy', 'anchor', 'animation', 'anode', 'cathode',
 ...
 'bacteria', 'balance', 'balloon', 'banana', 'barbecue', 'baseball', 'beaker', 'background',
 ...
 'journal', 'jockey', 'iteration', 'isometric', 'isolation', 'invitation', 'interval',
 ...
 'emission', 'elasticity', 'earthquake', 'dynamic', 'doctorate', 'divorce', 'derivation', 'nightmare', 'virtue', 'description'];
