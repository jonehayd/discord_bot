...
module.exports = {
    ...
    async execute(interaction) {
        ...
        try {
            ...
            console.error(error);
            return await interaction.reply({ content: `Could not fetch steam library. Make sure the ID is correct and your library is public.`, flags: MessageFlags.Ephemeral });
        }
    }
}
